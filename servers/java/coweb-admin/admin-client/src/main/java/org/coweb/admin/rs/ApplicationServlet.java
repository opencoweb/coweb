...
public class ApplicationServlet extends HttpServlet {
	...
	throws ServletException {
		...
		try {
			...
			Map<String,Object> session = this.cowebAdmin.getSession(name, sessionId);
	...
	throws ServletException {
		...
		try {
			String name = getServletContext().getServletContextName();
			Map<String, Object> application = cowebAdmin.getApplication(name);
	...
	throws ServletException {
		...
		int ret = cowebAdmin.registerApplication(title, 
				description, 
				appUrl, 
				thumbnailUrl);
	...
	throws ServletException {
		...
		boolean ret = cowebAdmin.unregisterApplication(title);
