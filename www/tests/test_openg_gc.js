...
//
dojo.provide('tests.test_openg_gc');
...
test('garbage collection #1', 0, function() {
    var a = new tests.util.OpEngClient(0, {symbol : ''});
    var b = new tests.util.OpEngClient(1, {symbol : ''});
    // don't thaw c yet, just create it
    var c = new tests.util.OpEngClient(2, {symbol : ''}, true);
...
test('garbage collection #2', 9, function() {
    var a = new tests.util.OpEngClient(0, {symbol : 'null'});
    var b = new tests.util.OpEngClient(1, {symbol : 'null'});
    var c = new tests.util.OpEngClient(2, {symbol : 'null'});
...
test('garbage collection #5', 7, function() {
    var a = new tests.util.OpEngClient(0, {symbol : '0'});
    var b = new tests.util.OpEngClient(1, {symbol : '0'});
    var op;
